...
def get_bpi11_data(target_activity, max_len, min_len):
    ...
    seq_act_features = ['1e consult poliklinisch','administratief tarief       - eerste pol','verlosk.-gynaec. korte kaart kosten-out','echografie  - genitalia interna','simulator - gebruik voor aanvang megavol','behandeltijd - eenheid t3 - megavolt','teletherapie - megavolt fotonen bestrali','aanname laboratoriumonderzoek','ureum','hemoglobine foto-elektrisch','creatinine','natrium vlamfotometrisch','kalium potentiometrisch','leukocyten tellen elektronisch','trombocyten tellen - elektronisch','ordertarief','ligdagen - alle spec.beh.kinderg.-reval.','sediment - spoed','bacteriologisch onderzoek met kweek -nie','resistentiebepalingen - 5 bepalingen','hepatitis-b surface antigeen confirmatie','urine onderzoek - kwalitatief','190021 klinische opname a002','190205 klasse 3b        a205','sgot - asat kinetisch','sgpt - alat kinetisch','melkzuurdehydrogenase -ldh- kinetisch','differentiele telling automatisch','trombotest','crp c-reactief proteine','brachytherapie - interstitieel - intensi','inwend.geneesk.  korte kaart kosten-out','vervolgconsult poliklinisch','creatinine - spoed','ijzer','natrium - vlamfotometrisch - spoed','kalium vlamfotometrisch - spoed','foliumzuur mbv radioisotopen','vitamine b12 mbv chemieluminescentie','bloedgroep abo en rhesusfactor','rhesusfactor d - centrifugeermethode - e','haemoglobine foto-electrisch - spoed','trombocyten tellen - spoed','reticulocyten tellen mbv facscan','cde fenotypering','bloedgroepantigenen andere dan abo-rhesu','kruisproef volledig -drie methoden-','leucocyten tellen -electronisch- spoed','crp c-reactief proteine - spoed','screening antistoffen erytrocyten','transferrine mbv ics','190101 bovenreg.toesl.  a101','gefiltreerd erytrocytenconcentraat','echo nieren-urinewegen','interc.consult klinisch  anesthesie','ureum - spoed','sgpt alat kinetisch - spoed','sgot asat kinetisch - spoed','international normalised ratio mbv tromb','dagverpleging - alle spec.beh.kind.-rev.','190035 dagverpleging    a007','urinezuur met uricase u.v. spectrofotome','melkzuur dehydrogenase - spoed','echo abdomen','sediment','klinische kaart - inwendige geneeskunde','inwend.geneesk.   aanv.kaart kosten-out','squamous cell carcinoma mbv eia','ct abdomen','ca-125 mbv meia','telefonisch consult','patient niet verschenen radiologie','homocystine chromatografisch','cytologisch onderzoek - ectocervix -','bilirubine -geconjugeerd','bilirubine - totaal','glucose','alkalische fosfatase -kinetisch-','gammaglutamyltranspeptidase','cea - tumormarker mbv meia','calcium','albumine','thorax','190204 klasse 3a        a204','buik        - stag.lap-tumorred.-omentec','immunopathologisch onderzoek','cytologisch onderzoek - ascites -','histologisch onderzoek - grote resectiep','glucose - spoed','calcium - spoed','melkzuur enzymatisch - spoed','o2-saturatie','ct thorax','verlosk.-gynaec.  aanv.kaart kosten-out','hematocriet mbv centrifuge','totaal eiwit','vulva       - rad.vulvectomie - opp.en d','microscopisch onderzoek - gekleurd en on','coupe ter inzage','mri bekken','skelet - scintigrafie totale lichaam','e.c.g.      - elektrocardiografie','lithium','tsh enzym-immunologisch','vrij t4 mbv ria -ft 4','1e consult      bezoek','lymfeklier - scint sentinel node dynamis','lymfeklier - scint sentinel node vervolg','lymfeklier - scint sentinel node met pro','vulva       - radicale vulvect. znd ingu','vriescoupe','methemoglobine - sulfhemoglobine elk','bicarbonaat','co-hb kwn.','actuele ph - pco2 - stand.bicarbonaat','lithium - spoed','histologisch onderzoek - biopten nno','verlosk.-gynaec.   jaarkaart kosten-out','histologisch onderzoek - kleine resectie','cito histologisch onderzoek','vrw.gesl.org- biopsie-punctie-cytologie','blaas       - uretrocystoscopie nno','vagina      - toucher onder anesthesie','bezinkingssnelheid foto-elektrisch','buikoverzicht','klinische kaart - anesthesie','anesthesie  - bij behandeling met radium','arterie     - punctie tbv.verblijfsnaald','thorax - op zaal','chloride - spoed','fosfaat - spoed','protrombinetijd -quick owren of modif.-','heparinebepaling - kaoline - cefalinetij','albumine - spoed','interc.consult klinisch  longziekten','dieet nno','buik        - primaire stageringsoperati','behandeltijd - eenheid t1 - megavolt','fosfaat','chloride','magnesium  -aas','bekken - liggend','bovenbeen','onderbeen','alkalische fosfatase - kinetisch - spoed','magnesium  -aas - spoed','buik        - stageringslaparotom.-oment','infuus      - inbrengen','echografie  - blaas - extern','mammografie thoraxwand','echo mamma','vrw.gesl.org- curettage gefractioneerd','vulva       - biopsie-punctie-cytologie','uterus      - hysteroscopie','ligase chain reaction -lcr-','uterus      - intra-uterine device inbre','cytologisch onderzoek - vagina -','mri bijnier','melkzuur enzymatisch','behandeltijd - eenheid t4 - megavolt','ct bekken','bekken - staand','heup','ct wervelkolom - lumbaal','bot - densitometrie lwk','bot - densitometrie femurhals','alfa-1-foetoproteine','vrw.gesl.org- exc.destruct.path.afwijkin','mri abdomen','analgesie   - epiduraal door anesthesist','eiwit beperkt - mineralen beperkt','urinewegen  - urodynamisch onderzoek-vij','uterus      - extirpatie abdominaal radi','maag - ontledig.-scint vast-vloeib.voeds','darm - colonpassage scint.comp.vervolg','mri wervelkolom - lumbaal','mri heup','paclitaxel','kreatinine fosfokinase - spoed','creatine fosfokinase mb - spoed','troponine-t mbv elisa','behandeltijd - eenheid t2 - megavolt','ovarium     - debulking ovariumcarcinoom','cervix      - lisexcisie portio - diathe','hematocriet - spoed','uterus      - extirpatie abdominaal tota','cefalinetijd - coagulatie','protrombinetijd','cholesterol totaal','triglyceriden - enzymatisch','cholesterol hdl','hart        - doppler echocardiografie 2','uterus      - carc. cervix vlgs. werthei','hematologie - ontstek.scint.tot.lichaam','ovarium     - adnex-extirpatie dmv lapar','gamma glutamyltranspeptidase - spoed','pyelografie --wo niertransplantaat--','blaas       - suprapubische katheter inb','dikke darm  - sigmoidoscopie met flexibe','vulva       - vulvectomie zonder lieskli','interc.consult klinisch  radiotherapie','erytrocyten leukocyten verwijderd bestra','differentiatie leukocyten - handmatig','interc.consult klinisch  neurologie','klinisch tarief','cytologisch onderzoek - diversen -','totaal t4 - thyroxine immunofluorimetris','vagina      - biopsie-punctie-cytologie','blaas       - cystoscopie','perif.vaten - duplexonderzoek - veneus','clostridium elisa-test','dikke darm  - appendectomie nno','bilirubine kwantitatief totaal of direct','punctie tbv cytologisch onderzoek door p','cytologisch onderzoek - urine niercyste','schoudergewricht','bovenarm','colon inloop','anesthesie  - bij spec.onderz.en verr.ge','vagina      - scopie incl.evt.vulvabiops','vagina      - overige excisie pathologis','vulva       - ruime lokale excisie van a','nieren - renografie lasix','vulva       - vulvectomie - liesblok','totaal eiwit colorimetrisch - spoed','echo bovenbuik','uterus      - extirpatie - abdominaal me','ct lever en galwegen','onderzoek van elders niet beoordeeld','cervix      - conisatie','morfometrie','directe antiglobulinetest - coombs','bloedgroepbep. anders dan abo per bloedg','antistoffen tegen erys - specificiteit -','ident. irregulaire a.s. tegen erys na po','uitsluiten irregulaire a.s. tegen erys d','cytologisch onderzoek - lymfeklierpuncti','punctie cyste tumor ed. door radioloog o','pyelografie antegraad via punctie','uterus      - curettage - diagnostisch','cervix      - curettage','buik        - stag.laparotom.-omentect.-','echo tractus urogenitalis-bekken','kalium vlamfotometrisch','eiwit -colorimetrisch- totaal','microalbumine immunonefelometrisch','ct hals','aluminium','erytrocyten tellen - elektronisch','betasubunit bep. mbv. ria hcg','fsh enzym-immunologisch','lh mbv radioisotopen','progesteron mbv radioisotopen','prolactine mbv eia','oestradiol mbv radioisotopen -ria','vrw.gesl.org- plastische operatie van vu','testosteron mbv radioisotopen','sex-hormone-binding globuline mbv ria','ca-19.9 tumormarker','diagnostische punctie onder echocontrole','echo hals --waaronder schildklier--','vagina      - tension-free vaginal tape','vagina      - colpocleisis lefort','ct bovenbuik','natrium vlamfotometrisch - spoed','lymf.syst.  - stageringslymfadenectomie','widal agglutinatie - yersinia 3','widal agglutinatie - yersinia 9','amylase','dikke darm  - colonoscopie met biopsie','inwend.geneesk.    jaarkaart kosten-out','hemoglobine a1','wervelkolom - lumbaal','tumor - petscan totale lichaam','klinische kaart - verloskunde en gynaeco','vulva       - partiele vulvectomie','mri grote hersenen','buik        - proeflaparotomie','vrw.gesl.org- adnex-extirpatie dmv lapar','zwangerschapsreactie','anti-hepatitis-c-virus mbv elisa','hepatitis-c-virus roche -hcvr- mbv pcr','anti-hiv mbv elisa','alfa amylase - spoed','cervix      - portio - lasercoagulatie','vagina      - scopie excl.weefselwegname','190034 afwezigheidsdag  a006','interc.consult klinisch  chirurgie','ca 15.3 - tumormarker mbv meia','cytologisch onderzoek - pleuravocht -','huidplastiek- z-plastiek huid hoofd en h','pyelografie antegraad via drain','ct totale lichaam','pyelografie retrograad','echo pancreas en milt','brain natriuretic peptide -bnp- mbv immu','ferritine kwn mbv chemieluminescentie','chloride -ionselectief-','onderz. naar aanwezigheid van koude anti','geb. antistoffen tegen erys - dir.coombs','geb. antistoffen tegen erys - dir. coomb','ovarium     - redebulking ovarium carcin','creatinefosfokinase -kinetisch-','lipase','duplexscan - venen been','toonaudiometrie - audiologisch centrum','hoogfrequente audiometrie - audiologisch','patienten kontakt audiologie korter dan','titratie directe antiglobulinetest - coo','elutie van auto-antistoffen tegen erytro','bloedgroepbepaling anders dan abo  kidd','echo onderbuik','buik        - excisie patholog.afwijking','17-hydroxyprogesteron mbv ria','delta-4-androsteendion','dhea-sulfaat met extractie mbv ria','vrw.gesl.org- aspiratie of microcurett.-','interc.consult klinisch  interne ziekten','digoxine','bronchus    - bronch.toilet door verpl.-','ct hersenen','uterus      - extirp.abd.rad. - lymfaden','immunoglobuline a                    iga','vitamine b1 - thiamine','hart        - resuscitatie','uterus      - extirpatie abdom.totaal me','longfunctie - co2 - capnografie','vrw.gesl.org- adhesiolysis ovarium plus','cytologisch onderzoek - vulva -','ct retroperitoneum','anti-hav ig of igg-elisa of ria- in een','antist.tegen hepatitis-b surface antigee','hepatitis-b-anti-core igm','echogeleide als ass.bij punctie-biopsie','ethanol -enzymatisch of gaschromatografi','buik        - littekenbreuk - plastische','zwangerschapsreactie - spoed','hyperthermie','vagina      - operatie vesicovaginale fi','vulva       - hechten van vulva','ct-gel. als ass. bij punctie - biopsie i','buik        - punctie ascites ontlastend','antitrombine iii mbv chromogeen-n-substr','cytologisch onderzoek - endocervix -','oestron mbv radioisotopen','cytologisch onderzoek - leverpunctie -','fibrinogeen','vagina      - vaginotomie','echografie a vue ivm zwangerschap - rout','echografie a vue ivw zwangerschap - met','echo been','fdp - dimeer - immunologisch','ct a.pulmonalis','proteine-c-activiteit','igm anticardiolipine mbv elisa','igg anticardiolipine mbv elisa','antist. specifiek mbv elisa histonen of','trombinetijd','stollingsfactor - viii - activiteit','anticoagulans lupus mbv elisa','proteine-s-antigeen -totaal','proteine-s-antigeen -vrij','factor ii mutatie mbv pcr','factor v leiden -r506q- mbv dna-test','tuba uterina- excisie parovariale cyste','echo bovenbeen','mri wervelkolom - thoracaal','pijnbestrijd- aanleggen patient controll','spraakaudiometrie  -  standaard - audiol','mandibula-kaakgewricht','mri orbita','mri wervelkolom - cervicaal','high sensitive crp -hscrp- nefelometrisc','echo arteriae carotis sinistra','echo arteriae carotis dextra','onderzoek via percutane veneuze katheter','ven. d.s.a. vena cava inferior','creatine fosfokinase isoenzym ckmb','haptoglobine','uterus      - excisie-destructie path.af','rib-sternum','hyperthermie behandeling - h-1 -','echografie-doppler venen been','afereseplasma gesplitst fq1 en fq2','mictie-cysto-uretrografie','ct nier','totale gebitsstatus','orthopantomogram \'panoramixopname\' gebit','vrw.gesl.org- adhesiolysis ovaria-tubae','ct pancreas en milt','doorlichting zonder opname buik','cytologisch onderzoek tbv bevolkingsonde','blaas       - cystoscopie met biopsie','vaten       - venapunctie','uterus      - extirpatie vaginaal totaal','nucleair onderzoek van elders','unknown','peritoneum  - omentectomie','vulva       - therapeutische punctie aan','urethra     - dilatatie meatus','infuus      - bloed','cytologisch onderzoek - buiktumorpunctie','echogeleide als ass. bij punctie abdomen','echo schouder - m-z bovenarm','prostaatspecifiek antigeen -psa- mbv imm','buik        - laparoscopie - diagnostisc','vrw.gesl.org- operatie van clitoris nno','opname volgens barsonie','lymf.syst.  - lymfeklierextirpatie para-','uterus      - extirp.abd.vag.rad.- lymfa','anti-rubella igg -elisa - in een monster','anti-chlamydia iga mbv elisa','anti-chlamydia igg mbv ind.ift','buik        - adhesiolyse en biopsie dmv','endoretrograde cholangiografie','cystografie retrograad','mri tractus urogenitalis','longfunctie - spirometrie','longfunctie - stroomvolume curve','ro-gel. als ass. bij punctie - biopsie l','339849d toegangschir- c.v.d.-catheter v.','trombocyten - leuko verwijderd - 5 donor','hemoglobinen -abnormaal incl. hba2','cytologisch onderzoek - liquor cerebrosp','immunoglobuline m                    igm','igg-index','erytrocyten','albumineratio','aspect supernatant','immuno-elektroforese liquor na concentra','osmolaliteit','huid        - verwijderen retentie cyste','ro-gel. als ass. bij inbrengen endoproth','lymf.syst.  - regionale lymfeklierdissec','brachytherapie - interstitieel - bijzond','echo buikwand','lever       - excisie tumor of metastase','lymf.syst.  - sentinel node procedure li','bekken','niet declarabele dagverpleging-bv klin.p','hele bovenbeen met onderbeen en voet','vrw.gesl.org- second-look-oper.ovariumca','wisselen drain onder rontgencontrole','doorlichting bij niersteenvergruizing','verwisselen van nefrostomie drain','oesofagografie - oraal','rontgenonderzoek onvolledig','knie - m-z onderbeen','mri art. en ven.abdomen','ct art. en ven.pulmonales','mec-a-bepaling voor mrsa mbv pcr','vagina      - extirpatie van vagina met','ureter - splintografie cq opspuiten uret','neuronspecifiek enolase','ct knie','interc.consult poliklinisch','echo thorax','obductie','gentamycine kwn - immuno-assay','anesthesie  - epiduraal met bloedpatch','dikke darm  - resectie sigmoid met prima','dikke darm  - appendectomie acuut via me','totaal t3 - trijoodthyronine mbv radiois','t3-uptake latente bindingscap. geb. tbg','echo bekken inhoud muv anatomiecode 83 t','uterus      - tot. laparoscopische hyste','wervelkolom - cervicaal','wervelkolom - thoracaal','wervelkolom - thoracolumbale overgang','plaatsen van v.cava filter','interc.consult klinisch  urologie','microscopisch onderzoek  - elektronenmic','eerste hulp - niet seh afdeling - elders','buik        - second-look-oper.ovariumca','itraconazol mbv hplc','bepaling hepatitis-be-antigeen','bepaling antist. hepatitis-be-antigeen']
